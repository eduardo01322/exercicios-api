...
```
 git clone https://github.com/eduardo01322/exercicios-api.git
```
...
[![Run in Insomnia}](https://insomnia.rest/images/run.svg)](https://insomnia.rest/run/?label=Exerc%C3%ADcios%20API&uri=https%3A%2F%2Fraw.githubusercontent.com%2Feduardo01322%2Fexercicios-api%2Fmain%2FInsomnia.json)
```
